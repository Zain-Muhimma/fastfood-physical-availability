          ...
          <div className="bg-card rounded-card p-5 animate-slide-up" style={{ animationDelay: '160ms' }}>
            ...
            <div className="grid grid-cols-2 gap-2">
              {[
                ...
                fb === leaderBrand && { badge: 'LEADER', bg: 'bg-green-50', border: 'border-green-300', badgeBg: 'bg-green-600', title: 'Category Leader', desc: 'Leading on Presence. Per EBI, maintain broad distribution to sustain leadership — market share reflects physical availability reach.' },
                fb !== leaderBrand && { badge: 'DOUBLE J', bg: 'bg-amber-50', border: 'border-amber-300', badgeBg: 'bg-amber-500', title: 'Double Jeopardy', desc: `Per Double Jeopardy, ${fb} as a smaller brand has both fewer buyers and lower loyalty. Growth requires expanding physical availability to reach new category buyers, not deepening loyalty` },
